...
| `mist_power_level = low` | Випаровування - низька інтенсивність |
| `mist_power_level = medium` | Випаровування - середня інтенсивність |
| `mist_power_level = high` | Випаровування - висока інтенсивність |
...
Блок `Режим` у панелі стану підсистеми містить тільки дві плитки:
...
Потужність
    Випаровування - середня інтенсивність
```
